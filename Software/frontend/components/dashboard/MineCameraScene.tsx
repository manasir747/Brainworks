  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient id="cam-bench" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#6a5f52" />
          <stop offset="100%" stopColor="#3a342c" />
        </linearGradient>
        <linearGradient id="cam-road" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#7a7368" />
          <stop offset="100%" stopColor="#4a453c" />
        </linearGradient>
        <radialGradient id="cam-mist" cx="50%" cy="40%" r="70%">
        ...
        <radialGradient id="cam-headlight" cx="50%" cy="108%" r="62%">
      ...
      <rect width="1600" height="900" fill="url(#cam-sky)" />

      <path d="M0 390 L260 360 L390 430 L180 470 L0 500 Z" fill="url(#cam-bench)" />
      <path d="M1600 390 L1340 360 L1210 430 L1420 470 L1600 500 Z" fill="url(#cam-bench)" />
      <path d="M0 500 L210 455 L480 520 L0 640 Z" fill="#4d463d" />
      <path d="M1600 500 L1390 455 L1120 520 L1600 640 Z" fill="#4d463d" />

      <path d="M210 900 L690 448 L910 448 L1390 900 Z" fill="url(#cam-road)" />
      <path
        d="M800 450 L794 900"
        stroke="#d2cdc2"
        strokeWidth="3"
      ...
      <rect x="0" y="0" width="1600" height="900" fill="url(#cam-mist)" />
      <rect x="0" y="0" width="1600" height="900" fill="url(#cam-headlight)" />
